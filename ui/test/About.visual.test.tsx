    ...
    installFetchMock([
      {
        ...
        json: {
          ...
          automaticModuleName: 'ch.sbb.polarion.extension.extension_name',
          bundleVersion: '1.0.0',
      ...
      },
      {
        ...
        json: {
          properties: [
            {
              key: 'ch.sbb.polarion.extension.extension-name.some.property',
              value: 'value',
              defaultValue: 'value',
      ...
      },
      {
        ...
        json: [{ name: 'Extension Name', status: 'OK', details: 'ready' }],
      },
      {
        method: 'GET',
        match: /\/readme$/,
        respond: () =>
          new Response(
            '<h1>Extension Name Extension for Polarion ALM</h1><p>What this extension does, from README.md.</p>',
            { status: 200 },
          ),
      },
    ]);
