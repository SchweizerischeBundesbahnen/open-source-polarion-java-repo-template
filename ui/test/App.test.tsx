...
const aboutRoutes = () => [
  {
    method: 'GET',
    match: /\/version$/,
    json: { bundleName: 'Extension Name', bundleVendor: 'SBB', bundleVersion: '1.0.0' },
  },
...
afterEach(() => {
  ...
  document.cookie = 'extension-name-dev-scope=; path=/; max-age=0';
});
...
describe('App router', () => {
  ...
  it('renders the About page for ?feature=about', async () => {
    ...
    expect(document.body.textContent).toContain('Extension Name');
